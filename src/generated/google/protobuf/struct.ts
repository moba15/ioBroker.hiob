...
export namespace google.protobuf {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message, () =>
                            pb_1.Map.deserializeBinary(message.fields as any, reader, reader.readString, () => {
                                let value;
    ...
    export class ListValue extends pb_1.Message {
        ...
        static fromObject(data: { values?: ReturnType<typeof Value.prototype.toObject>[] }): ListValue {
