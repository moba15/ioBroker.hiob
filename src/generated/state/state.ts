...
export class AllObjectsResults extends pb_1.Message {
    ...
    static fromObject(data: { states?: ReturnType<typeof State.prototype.toObject>[] }): AllObjectsResults {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): AllObjectsResults {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.states, () =>
...
export class StatesValueUpdate extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): StatesValueUpdate {
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 2:
                    reader.readMessage(message.stateUpdates, () =>
...
export class StateValueUpdateRequest extends pb_1.Message {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): StateValueUpdateRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
            message = new StateValueUpdateRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup()) {
                break;
            }
...
export class StateValueUpdateResponse extends pb_1.Message {
    ...
    static fromObject(data: { suc?: boolean }): StateValueUpdateResponse {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): StateValueUpdateResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
            message = new StateValueUpdateResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup()) {
                break;
            }
...
export class StateSubscribtion extends pb_1.Message {
    ...
    get type() {
        return pb_1.Message.getFieldWithDefault(
            this,
            2,
            StateSubscribtion.SubscriptionType.cancle,
        ) as StateSubscribtion.SubscriptionType;
    }
    ...
    static fromObject(data: { type?: StateSubscribtion.SubscriptionType; stateIds?: string[] }): StateSubscribtion {
...
export class SearchStateRequest extends pb_1.Message {
    ...
    static fromObject(data: { userId?: string; query?: string }): SearchStateRequest {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SearchStateRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
            message = new SearchStateRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup()) {
                break;
            }
...
export class SearchStateResponse extends pb_1.Message {
    ...
    static fromObject(data: { states?: ReturnType<typeof State.prototype.toObject>[] }): SearchStateResponse {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SearchStateResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
            message = new SearchStateResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup()) {
                break;
            }
...
export class State extends pb_1.Message {
    ...
    get common() {
        return pb_1.Message.getWrapperField(this, State.StateCommon, 6);
    }
...
export abstract class UnimplementedStateUpdateService {
    ...
    abstract UpdateValue(
        call: grpc_1.ServerUnaryCall<StateValueUpdateRequest, StateValueUpdateResponse>,
        callback: grpc_1.sendUnaryData<StateValueUpdateResponse>,
    ): void;
    abstract SearchState(
        call: grpc_1.ServerUnaryCall<SearchStateRequest, SearchStateResponse>,
        callback: grpc_1.sendUnaryData<SearchStateResponse>,
    ): void;
    abstract SearchStateStream(call: grpc_1.ServerDuplexStream<SearchStateRequest, SearchStateResponse>): void;
    abstract GetAllObjects(
        call: grpc_1.ServerUnaryCall<AllObjectRequest, AllObjectsResults>,
        callback: grpc_1.sendUnaryData<AllObjectsResults>,
    ): void;
}
export class StateUpdateClient extends grpc_1.makeGenericClientConstructor(
    ...
    Subscibe: GrpcStreamServiceInterface<StateSubscribtion, StatesValueUpdate> = (
        message: StateSubscribtion,
        metadata?: grpc_1.Metadata | grpc_1.CallOptions,
        options?: grpc_1.CallOptions,
    ): grpc_1.ClientReadableStream<StatesValueUpdate> => {
        return super.Subscibe(message, metadata, options);
    };
    UpdateValue: GrpcUnaryServiceInterface<StateValueUpdateRequest, StateValueUpdateResponse> = (
        message: StateValueUpdateRequest,
        metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<StateValueUpdateResponse>,
        options?: grpc_1.CallOptions | grpc_1.requestCallback<StateValueUpdateResponse>,
        callback?: grpc_1.requestCallback<StateValueUpdateResponse>,
    ): grpc_1.ClientUnaryCall => {
    ...
    SearchState: GrpcUnaryServiceInterface<SearchStateRequest, SearchStateResponse> = (
        ...
        metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<SearchStateResponse>,
    ...
    SearchStateStream: GrpcChunkServiceInterface<SearchStateRequest, SearchStateResponse> = (
        metadata?: grpc_1.Metadata | grpc_1.CallOptions,
        options?: grpc_1.CallOptions,
    ): grpc_1.ClientDuplexStream<SearchStateRequest, SearchStateResponse> => {
        return super.SearchStateStream(metadata, options);
    };
    GetAllObjects: GrpcUnaryServiceInterface<AllObjectRequest, AllObjectsResults> = (
