...
export abstract class UnimplementedstateServiceService {
    static definition = {
        Subscibe: {
...
export class stateServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedstateServiceService.definition, "stateService", {}) {
