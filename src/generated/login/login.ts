...
export class CompatibilityRequest extends pb_1.Message {
    ...
    static fromObject(data: { buildnumber?: string; versionumber?: string }): CompatibilityRequest {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CompatibilityRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
            message = new CompatibilityRequest();
...
export class CompatibilityResponse extends pb_1.Message {
    ...
    static fromObject(data: { buildnumber?: string; versionumber?: string }): CompatibilityResponse {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CompatibilityResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes),
            message = new CompatibilityResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup()) {
                break;
            }
...
export class FirstPing extends pb_1.Message {
    ...
    static fromObject(data: { buildnumber?: string; versionumber?: string }): FirstPing {
...
export class LoginResponse extends pb_1.Message {
    ...
    static fromObject(data: { status?: LoginResponse.Status; errorMsg?: string; sessionId?: string }): LoginResponse {
...
export class ApprovalRequest extends pb_1.Message {
    ...
    static fromObject(data: { deviceName?: string; deviceId?: string }): ApprovalRequest {
...
export class ApprovalResponse extends pb_1.Message {
    ...
    static fromObject(data: { status?: ApprovalResponse.Status; key?: string }): ApprovalResponse {
...
export abstract class UnimplementedLoginService {
    ...
    abstract CheckCompatibility(
        call: grpc_1.ServerUnaryCall<CompatibilityRequest, CompatibilityResponse>,
        callback: grpc_1.sendUnaryData<CompatibilityResponse>,
    ): void;
    abstract Login(
    ...
    abstract RequestApproval(
        call: grpc_1.ServerUnaryCall<ApprovalRequest, ApprovalResponse>,
        callback: grpc_1.sendUnaryData<ApprovalResponse>,
    ): void;
}
export class LoginClient extends grpc_1.makeGenericClientConstructor(
    ...
    CheckCompatibility: GrpcUnaryServiceInterface<CompatibilityRequest, CompatibilityResponse> = (
        message: CompatibilityRequest,
        metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<CompatibilityResponse>,
    ...
    RequestApproval: GrpcUnaryServiceInterface<ApprovalRequest, ApprovalResponse> = (
        message: ApprovalRequest,
        metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<ApprovalResponse>,
        options?: grpc_1.CallOptions | grpc_1.requestCallback<ApprovalResponse>,
        callback?: grpc_1.requestCallback<ApprovalResponse>,
    ): grpc_1.ClientUnaryCall => {
