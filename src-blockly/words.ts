...
const README = 'https://github.com/moba15/ioBroker.hiob/blob/main/README.md';

/** Fills `Blockly.Words` with everything the hiob blocks need */
export function installWords(): void {
    ...
    Blockly.Words.hiob_help = { en: README };
}
