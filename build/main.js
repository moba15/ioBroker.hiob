...
class SamartHomeHandyBis extends utils.Adapter {
  ...
  async saveNotificationUserUuid(uuid) {
    var _a;
  ...
  checkCompatibility(versionNumber) {
    if (minVersionNumber.localeCompare(versionNumber, void 0, { numeric: true, sensitivity: "base" }) <= 0) {
      return true;
    }
    return false;
  }
