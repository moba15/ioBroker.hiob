      ...
      static fromObject(data) {
        ...
        if (typeof data.fields == "object") {
          message.fields = new Map(
            Object.entries(data.fields).map(([key, value]) => [key, Value.fromObject(value)])
          );
        }
        return message;
      }
      toObject() {
        ...
        if (this.fields != null) {
          data.fields = Object.fromEntries(
            Array.from(this.fields).map(([key, value]) => [key, value.toObject()])
          );
        }
        return data;
      }
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              reader.readMessage(
                message,
                () => pb_1.Map.deserializeBinary(message.fields, reader, reader.readString, () => {
                  let value;
        ...
        while (reader.nextField()) {
          ...
          switch (reader.getFieldNumber()) {
            case 1:
              reader.readMessage(
                message.values,
                () => pb_1.Message.addToRepeatedWrapperField(message, 1, Value.deserialize(reader), Value)
              );
              break;
            default:
              reader.skipField();
