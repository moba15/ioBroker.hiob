...
# ioBroker Infos, News und Updates

### 1.   Javascript Adapter >= 7.9.0 die nötigen Rechte geben

![example_info_js.png](img/example_update/example_info_js.png)

### 2.   Blockly Script importieren

-   `host_name` Name vom Host (siehe Bild weiter unten)
-   `lang` Mögliche Sprachen en, de, ru, pt, nl, fr, it, es, pl, uk und zh-cn
-   `channelname` Name vom Channel unter 0_userdata.0
-   `load_temp` Temperatur vom Raspberry laden
...
### 3.   Aufzählung erstellen
 -  Eine neue Aufzählung erstellen und die 3 States hinzufügen</br>
![example_info_enum.png](img/example_update/example_info_enum.png)

### 4.   Widget Table erstellen

-   **Table und Datenpunkt für Updates auswählen**
...
-   **Den Table kopieren für Infos und News**
...
-   **Table und Datenpunkt für Infos auswählen und Columns anpassen**
...
-   **Table und Datenpunkt für News auswählen und Columns anpassen**
...
-   **3 Gruppen für Infos, News und Updates anlegen**

  ![example_info_create_groups.png](../en/img/example_update/example_info_create_groups.png)

-   **In den jeweiligen Gruppen nun den Table hinzufügen**
