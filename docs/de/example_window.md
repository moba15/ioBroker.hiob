...
-   `window_states` Hier müssen nun die States, die überwacht werden sollen, hinzugefügt und bennannt werden. Diese Objekte werden dann unter alias.0.<alias_object_name> angelegt. Müssen Objekt gewechselt oder gelöscht werden, dann bitte diese Änderung im Blockly ausführen. Objekte die hier nicht eingefügt sind, werden um 14 Uhr automatisch überprüft und können gelöscht werden. Diese Überprüfung kann weiter unten eingestellt werden.
-   `function_name` Der Name vom Objekt-State welches unter `enum.function` angelegt wird.
-   `userdata_object_name` Der Name vom Objekt (channel) welches unter `0_userdata.0` angelegt wird. Hier wird der Table_Json für VIS oder die APP gespeichert und aktualisiert.
-   `alias_object_name` Der Name vom Objekt welches unter `alias.0` (channel) angelegt wird. Hier werden dann die States aus der <door_states> neu erstellt und überwacht.
-   `check_alias_object` Bei true wird jeden Tag um 14 Uhr die States unter <alias_object_name> gegen <door_states> geprüft. Existieren dort States die nicht in <door_states> eingetragen sind, erscheint dieses als Warung im Log. Mit der Einstellung <auto_delete_object> können diese automatisch gelöscht werden.
-   `auto_delete_object` Automatische Löschung mit true erlauben.
-   `debuggen` Gibt Logs vom Script aus
-   `emoji_opened` Wird ausgegeben wenn ein Fenster geöffnet ist.
-   `emoji_closed` Wird ausgegeben wenn ein Fenster geschlossen ist.
-   `emoji_tilted` Wird ausgegeben wenn ein Fenster gekippt ist.
-   `value_for_closed_1` Value vom State für geschlossen (2 Möglichkeiten wegen unterschiedliche Hersteller) - Möglich boolean, number oder string
-   `value_for_closed_2` Value vom State für geschlossen (2 Möglichkeiten wegen unterschiedliche Hersteller) - Möglich boolean, number oder string
-   `value_for_opened_1` Value vom State für geöffnet (2 Möglichkeiten wegen unterschiedliche Hersteller) - Möglich boolean, number oder string
-   `value_for_opened_2` Value vom State für geöffnet (2 Möglichkeiten wegen unterschiedliche Hersteller) - Möglich boolean, number oder string
-   `value_for_tilted_1` Value vom State für gekippt (2 Möglichkeiten wegen unterschiedliche Hersteller) - Möglich boolean, number oder string
-   `value_for_tilted_2` Value vom State für gekippt (2 Möglichkeiten wegen unterschiedliche Hersteller) - Möglich boolean, number oder string
...
-   Datenpunkt `0_userdata.0.<userdata_object_name>.` hinzufügen

  ![example_window_enum.png](img/example_window/example_window_enum.png)

### 6.   Table Widget erstellen

-   **Table erstellen und Datenpunkt auswählen**

  ![example_window_create_table.png](../en/img/example_window/example_window_create_table.png)

-   **Columns add anlegen**

  ![example_window_create_table_column_add_name.png](../en/img/example_window/example_window_create_table_column_add_name.png)</br>
  ![example_window_create_table_column_add_status.png](../en/img/example_window/example_window_create_table_column_add_status.png)</br>
  ![example_window_create_table_column_done.png](../en/img/example_window/example_window_create_table_column_done.png)

-   **Angelegte Widget**

  ![example_window_create_table_done.png](../en/img/example_window/example_window_create_table_done.png)

-   **Screen erstellen**

  ![example_window_create_screen.png](../en/img/example_window/example_window_create_screen.png)</br>
  ![example_window_create_screen_add_icon.png](../en/img/example_window/example_window_create_screen_add_icon.png)

-   **Widget hinzufügen**

  ![example_window_create_screnn_add_table.png](../en/img/example_window/example_window_create_screnn_add_table.png)


### 7.   Fertig

  ![example_window_screen_done.png](../en/img/example_window/example_window_screen_done.png)</br>
  ![example_window.gif](../en/img/example_window/example_window.gif)
